    ...
    return Scaffold(
     backgroundColor: const Color.fromARGB(255, 240, 199, 60),
      appBar: AppBar(
        ...
        elevation: 0.0,
        centerTitle: true,
        title:const Text('Add Product',style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold,color: Colors.black),),
       /* actions: [
        ...
        return SingleChildScrollView(
          ...
          child: Padding(
            ...
            /*  ElevatedButton(onPressed: ()async{
               ...
               AppRouter.popRoute();
              }, child: Text('New Producet'))*/
                ElevatedButton(onPressed: ()async{
                         // await  provider.addNewCategory();
                        await provider.addNewProduct(catId);
                        await provider.getAllProducts(catId);
                          AppRouter.popRoute();
                         // Navigator.push(context, MaterialPageRoute(builder: ((context) => Navigator())));
                     //  AppRouter.NavigateToWidget(CategoriesScrean());
                          }, child: Text('Add Producet',style: TextStyle(color: Color.fromARGB(255, 240, 199, 60),fontSize: 20,fontWeight: FontWeight.bold),),
